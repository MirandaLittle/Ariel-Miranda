...
def custom_robot() -> CoreModule:
    ...
    hinge_9 = HingeModule(index=83)
    hinge_9.rotate(-90)
    core.sites[ModuleFaces.RIGHT].attach_body(
        body=hinge_9.body,
        prefix="hinge_9",
    )
    brick_7 = BrickModule(index=84)
