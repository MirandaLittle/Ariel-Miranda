...
def insect_small() -> CoreModule:
    ...
    hinge_2 = HingeModule(index=25)
    hinge_2.rotate(-90)
    brick_1.sites[ModuleFaces.LEFT].attach_body(
        body=hinge_2.body,
        prefix="hinge_2",
    )
    brick_2 = BrickModule(index=26)
