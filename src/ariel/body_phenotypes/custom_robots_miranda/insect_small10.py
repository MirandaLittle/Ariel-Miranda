...
def insect_small() -> CoreModule:
    ...
    hinge_7 = HingeModule(index=84)
    hinge_7.rotate(-45)
    core.sites[ModuleFaces.RIGHT].attach_body(
        body=hinge_7.body,
        prefix="hinge_7",
    )
    brick_7 = BrickModule(index=85)
