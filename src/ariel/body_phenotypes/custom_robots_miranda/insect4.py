...
def custom_robot() -> CoreModule:
    ...
    hinge_10 = HingeModule(index=14)
    core.sites[ModuleFaces.RIGHT].attach_body(
        body=hinge_10.body,
        prefix="hinge_10",
    )
    hinge_11 = HingeModule(index=22)
