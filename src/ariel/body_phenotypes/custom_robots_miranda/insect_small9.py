...
def insect_small() -> CoreModule:
    ...
    hinge_3 = HingeModule(index=72)
    hinge_3.rotate(-45)
    brick_1.sites[ModuleFaces.RIGHT].attach_body(
        body=hinge_3.body,
        prefix="hinge_3",
    )
    brick_3 = BrickModule(index=73)
