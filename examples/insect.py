...
def custom_robot() -> CoreModule:
    ...
    hinge_3 = HingeModule(index=19)
    hinge_2.sites[ModuleFaces.FRONT].attach_body(
        body=hinge_3.body,
        prefix="hinge_3",
    )
    brick_2 = BrickModule(index=20)
